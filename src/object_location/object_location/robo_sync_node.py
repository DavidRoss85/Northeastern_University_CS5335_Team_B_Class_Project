...
class RoboSyncNode(Node):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.destroy_node()
    #----------------------------------------------------------------------------------
    def __startup_turtlebot4(self):
        """Startup procedures for TurtleBot4"""
        #Enter code here for any startup procedures
        
        if self.__navigator.getDockedStatus():
            self.__navigator.info('Undocking before moving to pose')
            # Undock
